...
from process.train_cus_model2 import Train

if __name__ == '__main__':
    log = Logger('log/train_log_mymodel_fc7_res50.log', level='info')
    ...
    train_arg = {
        ...
        'weight_save_path': 'model/weight/2/fasterrcnn_resnet50_mymodel2.pth',
        'img_width': 1920,
        'img_height': 1080,
