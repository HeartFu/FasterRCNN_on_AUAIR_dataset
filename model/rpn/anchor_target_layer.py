...
class _AnchorTargetLayer(nn.Module):
    ...
    def __init__(self, feat_stride, scales, ratios,
                 rpn_negative_thresh=0.3, rpn_positive_thresh=0.7,
                 rpn_fg_fraction=0.5, rpn_batch_size=256, rpn_positive_weight=-1.0):
        ...
        self.rpn_negative_thresh = rpn_negative_thresh
        self.rpn_positive_thresh = rpn_positive_thresh
    ...
    def forward(self, input):
        ...
        labels[max_overlaps < self.rpn_negative_thresh] = 0
        ...
        labels[max_overlaps >= self.rpn_positive_thresh] = 1
